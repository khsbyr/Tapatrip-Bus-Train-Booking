...
export default function customerAssistant() {
  return (
    <>
      <Head>
        <title>Tapatrip - Customer Assistant</title>
      </Head>
      <div className="">
          ...
          <div className="max-w-7xl mx-auto text-cardDate space-y-5">
            ...
            <div className="text-base font-medium space-y-4">
              <p>
                ...
                integrated online travel services. Since 2007, subsidiary
                company "Tapatrip Agency" LLC has been officially providing its
                customers with the opportunity to fly to any city in the world.
              </p>
              <p>
                We provide a variety of adventurous travel services to customer
                that includes purchasing airline tickets to every location in
                the world, offering 1 million hotels in 195 countries of the
                world. “Tapatrip” platform is the next generation system based
                on artificial intelligence.
              </p>
              <p>
                Users will be able to use the platform with data analysis based
                on big data in Mongolian, English, and Chinese. The customers
                who choose us can get services and information in their mother
