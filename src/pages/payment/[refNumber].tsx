...
import Banks from '@components/payments/banks';
import Corporate from '@components/payments/corporates';
...
export default function payment({ NavData, refNumber, payments }) {
  ...
  const renderPayment = () => {
    console.log('payname : ', paymentName);
