...
import s from './classSleep.module.scss';
  ...
  return (
    <>
      {data?.map((mests, index) => (
        <div className="flex gap-x-2 lg:gap-x-10" key={index}>
          <div>
            <div className={s.plat5}>
            ...
            <div className={s.tableMainSleep}>
              <div className={s.tableSleep}></div>
            </div>

            <div className={s.plat6}>
              {mests?.map((mest, index) =>
                index < 5 && index > 3 ? (
                  <button
                    className={`${s.button} 
