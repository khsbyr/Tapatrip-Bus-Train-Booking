...
const Selector = () => <ChevronDownIcon className="w-6 h-6 text-white" />;
        ...
        <>
          ...
          <div className="relative mt-1 ">
            <span className="inline-block w-full rounded-md ">
              <Listbox.Button className="relative w-full rounded-md border-none border-gray-300  pl-3 pr-10 py-2 text-left  transition ease-in-out duration-150 cursor-pointer">
                <span className="block truncate text-white">
                  {selectedOption.text}
                </span>
                <span className="absolute inset-y-0 right-0 flex items-center pr-12 ml-3 pointer-events-none">
                  <Selector />
                </span>
              </Listbox.Button>
            </span>
